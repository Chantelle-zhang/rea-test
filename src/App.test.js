...
test("after click addItem, savedList add one item, and the item id is the same as the one clicked", async () => {
...
test("after click removeItem, savedList remove one item, and the removed item id is the same as the one clicked", async () => {
    const { container } = render(<App/>)
